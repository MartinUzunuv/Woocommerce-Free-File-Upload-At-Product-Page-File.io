// Display a file upload field and hidden custom note field on the single product page
add_action('woocommerce_before_add_to_cart_button', 'add_file_upload_and_visualization_field');
function add_file_upload_and_visualization_field() {
